---
title: Souveraineté
description: Pourquoi ton savoir projet doit t'appartenir, pas à un vendor.
---
...
Tout est du markdown. Des fichiers texte que tu possèdes, que tu versionnes dans git, que tu relis, sauvegardes et migres librement.
...
|------------|-----------|
| Le contexte vit dans l'historique de chat | Le contexte vit dans des fichiers que tu possèdes |
