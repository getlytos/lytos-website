---
title: Sovereignty
description: Why your project knowledge must belong to you, not a vendor.
---
...
Everything is markdown. Plain text files that you own, version in git, review, back up, and migrate freely.
