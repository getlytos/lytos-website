...
<p style="text-align: center; font-size: 1.2rem; font-weight: 700; margin: 2.5rem auto; max-width: 700px; color: var(--sl-color-accent);">Quality doesn't come from the prompt. It comes from the context.</p>
