...
| **GitHub Copilot Chat / Agents** | ✅ native | `.github/copilot-instructions.md` | Adapter planned — see [lytos-cli ISS-0039](https://github.com/getlytos/lytos-cli). |
| **Gemini CLI / Jules** | ✅ native | `GEMINI.md` | Adapter planned — see [lytos-cli ISS-0039](https://github.com/getlytos/lytos-cli). |
| **Windsurf / Codeium** | ✅ native | `.windsurfrules` | Adapter planned — see [lytos-cli ISS-0039](https://github.com/getlytos/lytos-cli). |
...
This covers **Claude Code (CLI and Desktop), Cursor, Codex CLI, Copilot, Gemini, Windsurf** once all adapters ship. No extra step per session.
